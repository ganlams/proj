...
namespace proj.Controllers
{
    public class LibrariansController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LibrarianId,Name,ContactDetails,Email")] Librarian librarian)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LibrarianId,Name,ContactDetails,Email")] Librarian librarian)
        {
            if (ModelState.IsValid)
            {
